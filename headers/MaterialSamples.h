...
// Some materials already configured
...
Material light(1.f, 1.f, 0.f, 1.f, 1.f, 0.f, 0.f, 0.f, 0.f, 1.f, 1.f, 1.f, 0.f);
Material emerald(0.2f, 0.2f, 0.2f, 0.6f, 0.6f, 0.6f, 0.3f, 0.3f, 0.3f, 10.f, 1.f, 1.f, 0.60f);